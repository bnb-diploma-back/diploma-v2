        ...
        final var courses = studentSyllabi.stream()
                .map(ss -> {
                    ...
                    return GetDashboardResponse.CourseSnapshotResponse.builder()
                            ...
                            .departmentName(syllabus.departmentId() != null ? resolveDepartmentName(syllabus.departmentId()) : null)
                            .majorId(syllabus.majorId())
                            .majorName(syllabus.majorId() != null ? resolveMajorName(syllabus.majorId()) : null)
