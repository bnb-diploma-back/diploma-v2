...
public class Databasechangeloglock extends TableImpl<Record> {
    ...
    public final TableField<Record, Boolean> LOCKED = createField(DSL.name("locked"), SQLDataType.BOOLEAN.nullable(false), this, "");

    public final TableField<Record, LocalDateTime> LOCKGRANTED = createField(DSL.name("lockgranted"), SQLDataType.LOCALDATETIME(6), this, "");
    ...
    private Databasechangeloglock(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Internal.createUniqueKey(Databasechangeloglock.DATABASECHANGELOGLOCK, DSL.name("databasechangeloglock_pkey"), new TableField[] { Databasechangeloglock.DATABASECHANGELOGLOCK.ID }, true);
    }
